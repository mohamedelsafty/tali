...
MapTo('tali/components/container')(ContainerV1Component, {
    isEmpty: ContainerIsEmptyFn,
});
MapTo('tali/components/experiencefragment')(ContainerV1Component, {
    isEmpty: ContainerIsEmptyFn,
});

MapTo('tali/components/download')(DownloadV1Component, {
...
MapTo('tali/components/breadcrumb')(BreadCrumbV2Component, {
    isEmpty: BreadCrumbV2IsEmptyFn,
});
MapTo('tali/components/button')(ButtonV1Component, {
...
const CarouselV1Component = () =>
    ...
    ).then((Module) => Module.CarouselV1Component);
